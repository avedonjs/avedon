...
- **adapter-static design (2026-07-30):** Spec approved — `docs/superpowers/specs/2026-07-30-adapter-static-design.md`. Fail-closed SSG-only (`out/client/`); create-app `--adapter=static`; www dogfood. Plan pending.
