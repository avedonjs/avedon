...
- **www home Counter specimen highlight (2026-07-29):** Hand-rolled `tok-*` spans → Shiki `highlightAve` via `generate` → `.generated/home-specimen.json`; Home `load()` injects HTML (docs ile aynı pipeline).
