...
| [`@avedon/compiler`](../packages/compiler) | Parse `.ave`, emit client/server modules, scoped CSS |
...
| [`@avedon/vite-plugin`](../packages/vite-plugin) | Vite transform, HMR, and dev middleware for `.ave` |
